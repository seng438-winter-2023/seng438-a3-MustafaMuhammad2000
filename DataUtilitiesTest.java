...
public class DataUtilitiesTest {
    ...
    public void setUp() throws Exception { 
	 ...
	 @Test
    // CalculateColumnTotal tests START
    //Mocking a Values2D object and calculating column total of the first column
	 ...
	 @Test
	//Mocking a Values2D object and calculating column total of the -1 index
	 public void testCalculateColumnTotal_ColumnIndexJustBelowLowerBoundary() {
	     mockingContext.checking(new Expectations() {
	         {
	        	 one(values).getRowCount();
	             will(returnValue(2));
	 ...
	 @Test
	 //Mocking a Values2D object and calculating column total of the matrix size-1 index 
	 ...
	 @Test
	 //Mocking a Values2D object and calculating column total of the matrix size index (outside the upper boundary) 
	 public void testCalculateColumnTotal_ColumnIndexJustAboveUpperBoundary() {
	     mockingContext.checking(new Expectations() {
	         {
	        	 one(values).getRowCount();
	             will(returnValue(2));
   ...
   //should return 0
	...
	@Test
	//Testing a 0-element array, should output a length of 0
	...
	public void testCreateNumberArray_ThreePositiveElementArrayMatchingNumberValue() {
		...
		assertEquals(Number.class, result[1].getClass());
		assertEquals(Number.class, result[2].getClass());
	}
	...
	//Testing a null input, should throw InvalidParameterException
    ...
    public void getCumulativePercentages_SinpleInputFourRows() {
    	...
    	assertEquals(0.75,res.getValue(0));
    	assertEquals(1.0,res.getValue(1));
    ...
    public void getCumulativePercentages_InvalidNegativeInputTwoRows() {
    	...
    	assertEquals(-0.5,res.getValue(0));
    	assertEquals(2.0,res.getValue(1));
  ...
  //For the function getCumulativePercentages()
    ...
    public void equal_BNullInput() {
    	double[][] input = new double[1][1];
    	assertEquals(true,DataUtilities.equal(input, null));
